// ==============================================
// TEMPLATE CoupleEventFormulaireBeditable
// ==============================================
Template.CoupleEventFormulaireBeditable.events({
	// Gestion des personnes
	
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// Spécificité B editable : "persB.pers_intitule"
	// PersB seule est éditable
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	
	'focus input[name$="persB.pers_intitule"]': function(e,tpl){
		...
		// S'il y a une personne dans le champ persA, on regarde son sexe et on force la recherche d'une personne de sexe opposée
		var autrePers = gf_persById(tpl.find('input[name=persA]').value);
...
Template.CoupleEventFormulaireBeditable.onRendered (function () {
