// ==============================================
// TEMPLATE DateformatLong
// ==============================================
Template.DateformatLong.helpers({
	// Booléens ------------------------------------------------------------ 
	//Attributs -------------------------------------------------------------
	'formatLong'  :  function () {
		// Traduction des mois ----------------------------------------
		...
		// Jour connu
			...
			// Mois connu
				...
				// Année connue
					...
					dateAff1 += " " + this.a1;
					// Si c'est une date républicaine, on rajoute la conversion
					if (CalendrierRepublicain.estJourRepublicain(this.j1,this.m1,this.a1)) dateAff1 += " (" + CalendrierRepublicain.gregToRep(this.j1,this.m1,this.a1).text + ")";
				}
			}
		}
		...
		// Jour connu
			...
			// Mois connu
				...
				// Année connue
					...
					dateAff2 += " " + this.a2;
					// Si c'est une date républicaine, on rajoute la conversion
					if (CalendrierRepublicain.estJourRepublicain(this.j2,this.m2,this.a2)) dateAff2 += " (" + CalendrierRepublicain.gregToRep(this.j2,this.m2,this.a2).text + ")";
				}
			}
		}
