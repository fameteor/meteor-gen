...
// ==============================================
Template.PersArbreDescExplorableRecursif.onCreated (function () {
	this.isExplored = new ReactiveVar(false);
});

Template.PersArbreDescExplorableRecursif.helpers({
	"isExplored" : function () {
...
Template.PersArbreDescExplorableRecursif.events({
